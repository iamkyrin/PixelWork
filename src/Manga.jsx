...
function Manga(){
    ...
    <div className="flex justify-center items-center h-screen">
       <LoadingTwotoneLoop className = "w-12 h-12"/>
    </div>
);
    ...
    return (
        <div className='p-20 w-[650px] lg:w-full lg:p-20 sm:p-2 overflow-x-hidden'>
            <div className='flex justify-center'>

                        <img
                src={`${manga.images.jpg.image_url}`}
                alt={`${manga.titles.title}`}
                className='cursor-pointer transform transition-transform duration-300 hover:scale-105 w-[600px] ml-2 lg:ml-0 sm:w-full md:w-full lg:w-[300px] sm:h-full md:h-screen lg:h-[400px] border-black rounded-[20px]'
                         >
                    </img>
            </div>

            <div className='p-10'>
                <h1 className='text-3xl'>{manga.titles.title}</h1>
                <h2 className='text-xl mt-2 text-gray-500'>{manga.titles.title_english}</h2>
                <h2 className='text-xl mt-2 text-gray-500'>{manga.titles.title_japanese}</h2>
            </div>
            ...
            <div className='flex flex-column w-170 mt-0 ml-7 gap-3'>
                <div className='flex bg-gray-100 rounded-full flex-row h-10 p-3'>
                    ...
                    <span className='text-xs'><b>{manga.score} </b>
                        
                        <span className='text-xs text-gray-600'> ({manga.scored_by.toLocaleString('en-US')})</span></span>
                </div>           

                <div className='flex border border-green-300 bg-green-300 text-black rounded-full flex-row h-10 p-3'>
                    <span className='text-xs'>{manga.status || "N/A"}</span>
                </div>
                

                <div className='flex border border-blue-300 bg-blue-300 text-white rounded-full flex-row h-10 p-3'>
                    <span className='text-xs capitalize'>{manga.type}</span>
                </div>
            </div>
            

            <div className='p-7'>
                <span className='text-gray-500 text-lg'>{manga.synopsis}</span>
            </div>




            <div className='grid grid-cols-2 sm:grid-cols-3 lg:gap-5 gap-5 w-[50rem] w-full mt-2 ml-2'>

                <div className='border border-gray-200 rounded-[10px] lg:w-[300px] w-[250px]'>
                    <div className='float-left'>
                    ...
                    <div className='flex flex-col justify-center p-2'>
                        <span>Volumes</span>
                        <span className='text-gray-500'>{manga.volumes || "N/A"}</span>
                    </div>
                ...
                <div className='border border-gray-200 rounded-[10px] lg:w-[300px] w-[250px]'>
                    ...
                    <div className='flex flex-col justify-center p-2'>
                        <span>Chapters</span>
                        <span className='text-gray-500'>{manga.chapters || "N/A"}</span>
                    </div>
               ...
               <div className='border border-gray-200 rounded-[10px] lg:w-[300px] w-[250px]'>
                ...
                <div className='flex flex-col justify-center p-2'>
                    <span>Published</span>
                    <span className='text-gray-500'>{manga.published.string}</span>
                </div>
               ...
               <div className='border border-gray-200 rounded-[10px] lg:w-[300px] w-[250px]'>
                ...
                <div className='flex flex-col justify-center p-2'> 
                    <span>Members</span>
                    <span className='text-gray-500'>{manga.members.toLocaleString('en-US')}</span>
                </div>
               ...
               <div className='border border-gray-200 rounded-[10px] lg:w-[300px] w-[250px]'>
                    ...
                    <div className='flex flex-col justify-center p-2'> 
                        <span>Rank</span>
                        <span className='text-gray-500'>#{manga.rank}</span>
                    </div>
               ...
               <div className='border border-gray-200 rounded-[10px] lg:w-[300px] w-[250px]'> 
                ...
                <div className='flex flex-col justify-center p-2'>
                    ...
                    <span className='text-gray-500'>{manga.favorites.toLocaleString('en-US')}</span>
                </div>
        ...
        <div className='p-2'>
            <h1 className='text-lg'><b>Authors</b></h1>
            <div className='cursor-pointer hover:bg-gray-300 px-4 py-2 flex justify-center border border-gray-200 rounded-full w-[500px] mt-2 mb-10 text-lg'>
            ...
            <div>
                    <h1 className='text-lg'><b>Serializations</b></h1>
                <div className="flex flex-wrap gap-2">
                    {manga.serializations.map(serializations => (
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-2">
                    {manga.demographics.map(demographics => (
