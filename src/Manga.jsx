...
function Manga(){
    ...
    return (
        <div className='w-[400px] md:w-full xl:w-full xl:p-20 p-2 overflow-x-hidden'>
            <div className='flex justify-center items-center'>

                        <img
                src={`${manga.images.jpg.image_url}`}
                alt={`${manga.titles.title}`}
                className='object-cover cursor-pointer md:ml-0 w-[350px] xl:ml-0 xl:w-full md:w-full h-screen md:h-screen xl:h-screen border-white rounded-[20px]'
                         >
                    </img>
            </div>

            <div className='xl:p-10 p-2'>
                <h1 className='xl:text-6xl font-bold lg:text-xl'>{manga.titles?.[0].title}</h1>
                <h2 className='xl:text-5xl lg:text-xl mt-2 text-gray-500'>{manga.titles?.[1].title}</h2>
                <h2 className='xl:text-3xl lg:text-xl mt-2 text-gray-500'>{manga.titles?.[2].title}</h2>
            </div>
            ...
            <div className='grid grid-cols-2 xl:grid-cols-4 xl:w-full w-full xl:mt-0 mt-5 xl:ml-7 md:ml-0 gap-3'>
                <div className='flex bg-gray-100 rounded-full flex-row h-10 p-3 w-[150px] xl:w-[250px] md:w-[250px]'>
                    ...
                    <span className='xl:text-sm text-xs'><b>{manga.score || 'N/A'} </b>
                        
                        <span className='xl:text-xs text-gray-600'> ({manga.scored_by.toLocaleString('en-US')})</span></span>
                </div>           
                ...
                <div className='h-10 p-3 w-[150px] xl:w-[250px] md:w-[250px] flex border border-green-300 bg-green-300 text-black rounded-full flex-row h-10 p-2 lg:p-3'>
                    <span className='xl:text-sm text-xs text-sm xl:ml-0 md:ml-0 ml-3'>{manga.status || "N/A"}</span>
                </div>
                ...
                <div className='h-10 p-3 w-[150px] xl:w-[250px] md:w-[250px] flex border border-blue-300 bg-blue-300 text-white rounded-full flex-row h-10 p-2 lg:p-3'>
                    <span className='xl:text-sm text-xs text-xl capitalize text-black'>{manga.type}</span>
                </div>
            </div>
            

            <div className='xl:p-9 p-0 xl:mt-0 mt-5'>
                <span className='text-gray-500 text-sm xl:text-lg'>{manga.synopsis}</span>
            </div>
        ...
        <div className='xl:p-10 p-0 xl:mt-0 mt-10'>
            ...
            <div className='cursor-pointer hover:bg-gray-300 px-4 py-2 flex justify-center border border-gray-200 rounded-full w-[350px] mt-2 mb-10 text-lg'>
