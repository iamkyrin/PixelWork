...
function AnimeInfo(){
    ...
    return (
        <div className='w-[650px] lg:w-full lg:p-20 sm:p-2 overflow-x-hidden'>
            <div className='flex justify-center'>
                ...
                allowFullScreen
                className='w-[600px] ml-2 lg:ml-0 sm:w-full md:w-full lg:w-full sm:h-full md:h-screen lg:h-screen aspect-video border-white rounded-[20px]'
                         >
                    </iframe>
            </div>

            <div className='p-10'>
                <h1 className='text-6xl font-bold lg:text-xl'>{anime.title}</h1>
                <h2 className='text-5xl lg:text-xl mt-2 text-gray-500'>{anime.title_english}</h2>
                <h2 className='text-3xl lg:text-xl mt-2 text-gray-500'>{anime.title_japanese}</h2>
            </div>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-3 lg:gap-5 gap-3 w-[50rem] w-full mt-2 ml-10'>
