    ...
    const tabContent = {
        tab1: (
            <div className='mt-10'>
                ...
                <p className='text-lg text-gray-500'>{manga.background}</p>
            </div>
        ...
        <div role = "tablist">
            {tabs.map((tab) => (
                ...
                className={`px-4 py-2 font-semibold ${
                            activeTab === tab.id ? "mt-10 lg:w-[450px] md:w-[120px] sm:w-[170px] w-[150px] bg-blue-500 text-white" : "mt-10 w-[150px] lg:w-[450px] md:w-[130px] sm:w-[170px] bg-gray-100 text-black"
                        }`}
